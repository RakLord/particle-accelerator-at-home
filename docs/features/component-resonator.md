...
Tierable. See `docs/features/component-tiers.md`. Higher tiers increase the per-neighbour Speed contribution. Tier tables live in `internal/sim/components/resonator.go`.
