...
var (
	...
	colorHeaderIncome = color.RGBA{0xd8, 0xd8, 0xee, 0xff}
	...
	colorInjectorHelium = color.RGBA{0x8a, 0xc8, 0xff, 0xff}
	colorAccelerator    = color.RGBA{0x4e, 0x8a, 0xff, 0xff}
	colorMeshGrid       = color.RGBA{0x4f, 0xbf, 0xc0, 0xff}
	colorMagnetiser     = color.RGBA{0xb4, 0x5a, 0xe0, 0xff}
	...
	colorSubjectHelium  = color.RGBA{0xff, 0xe8, 0xa0, 0xff}
	...
	colorPurchaseActive = color.RGBA{0x3e, 0x8a, 0x5e, 0xff}
)
